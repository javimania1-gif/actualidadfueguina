...
const noticias = defineCollection({
  ...
  schema: z.object({
    ...
    contentType: z.enum(['noticia', 'claves-af', 'analisis', 'entrevista', 'opinion', 'patrocinado']).default('noticia'),
    editorialProcess: z.enum(['automatico', 'revisado', 'original']).optional(),
    keyPoints: z.array(z.string().max(220)).max(4).default([]),
